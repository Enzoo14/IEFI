Public Class ClientesGrid
    ...
    Private Sub ClientesGrid_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        'ClientesCollection.DataSource = ClienteList.TraerClientes
    ...
    Private Sub Modificar_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ClienteForm.indice = DataGridView.CurrentRow.Index
        ...
        DataGridView.Rows.Item(fila).Selected = False
        DataGridView.Rows.Item(fila).Selected = True
    ...
    Private Sub Agregar_Click(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub Eliminar_Click(ByVal sender As Object, ByVal e As EventArgs)
        'Determina si existen filas en el DataGridView
        If DataGridView.Rows.Count = 0 Then
